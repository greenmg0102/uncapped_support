                        ...
                        <div className="mx-auto w-full max-w-[440px]">
                            ...
                            <div className="mb-10 md:mb-[60px]">
                                <ul className="flex justify-center gap-3.5">
                                    <li>
                                        <div
                                            onClick={() => authTest('instogram')}
                                            className="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110 cursor-pointer"
